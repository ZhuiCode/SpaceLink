...
const logEnv = "SPACELINK_GO_LOG_LEVEL"
...
// DefaultLogger is used by spacelink for logging.
...
func readLoggingEnv() LogLevel {
	...
	default:
		fmt.Fprintln(os.Stderr, "invalid spacelink log level")
		return LogLevelNothing
	}
}
